 ...
 *
 * Cache key is intentionally not origin-bucketed. ACAO is always `*` here
 * (public image, signature is the real access control), so every response is
 * byte-identical regardless of Origin. No poisoning surface.
 *
