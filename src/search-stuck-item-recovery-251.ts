...
function validateCheckpoint(): void {
	...
	assertEqual(checkpoint.recovery.workerName, 'newsence-search-stuck-item-recovery-251', 'recovery Worker');
	assertEqual(checkpoint.recovery.workflowName, 'newsence-search-index-stuck-item-recovery-251', 'recovery Workflow');
	assertEqual(checkpoint.recovery.instanceId, 'search-index-stuck-item-recovery-251-v1', 'recovery instance');
	assertEqual(checkpoint.recovery.approvalEventType, 'approve-stuck-item-recovery-251', 'recovery approval event type');
